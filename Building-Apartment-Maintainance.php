      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="section-title">
            <h1 class="text-capitalize mb-4">Having Trouble Collecting Maintenance?</h1>
            <p>We can help you collect your maintenance 3 times faster!</p>
                <a type="button"
        ...
        <div class="col-lg-7 text-center text-lg-end">
          <img loading="lazy" decoding="async" src="images/bg/features/building-maintenance-money-collection.png" alt="school-fee-collection" class="img-fluid rounded ">
        </div>   
      </div>
    </div>
    </section>
      ...
      <div class="container mt-4">
        <div class="row mt-2 align-items-center justify-content-between">
          <div class="section-title text-center">
            ...
            <h1>Features of Maintenance Collection <br>Software for Building Apartment Maintainance</h1>
