      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="section-title">
            <h1 class="text-capitalize mb-4">Send Reminders & Collect Payment On Whatsapp</h1>
            <p>Collect your Subscription 3 times faster by sending reminders with payment links!</p>
            <a type="button"
        ...
        <div class="col-lg-7 text-center text-lg-end">
          <img loading="lazy" decoding="async" src="images/bg/features/gym-payment-collection.png" alt="school-fee-collection" class="img-fluid rounded ">
        </div>   
      </div>
    </div>
    </section>
      ...
      <div class="container mt-4">
        <div class="row mt-2 align-items-center justify-content-between">
          <div class="section-title text-center">
            ...
            <h1>Features of Subscription Collection software <br>For Gyms and Fitness Centers Business</h1>
