      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="section-title">
            <h1 class="text-capitalize mb-4">Problem Collecting Your Rentals On Time?</h1>
            <p>Collect your Rentals on Whatsapp. Improve Cashflows!</p>
                <a type="button"
        ...
        <div class="col-lg-7 text-center text-lg-end">
          <img loading="lazy" decoding="async" src="images/bg/features/machinery-rental-collection.png" alt="school-fee-collection" class="img-fluid rounded ">
        </div>   
      </div>
    </div>
    </section>
      ...
      <div class="container mt-4">
        <div class="row mt-2 align-items-center justify-content-between">
          <div class="section-title text-center">
            ...
            <h1>Features of Payment Reminder Software for <br>Computer Printer Airconditioner Machinery Rentals</h1>
