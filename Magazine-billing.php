    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-7 text-center text-lg-end">
          <img loading="lazy" decoding="async" src="images/bg/features/magazine-bill-collection.png" alt="school-fee-collection" class="img-fluid rounded ">
        </div>   
      </div>
    </div>
    </section>
      ...
      <div class="container mt-4">
        <div class="row mt-2 align-items-center justify-content-between">
          <div class="section-title text-center">
            ...
            <h1>Features of Magazine <br> Subscription Collection Software</h1>
