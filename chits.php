      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="section-title">
            <h1 class="text-capitalize mb-4">Having Trouble Collecting Chits On Time?</h1>
            <p>We can help you collect your Chits 3 times faster on whatsapp. Reduce cancellations!</p>
            <a type="button"
          class="btn fs-6" style="background-color: #fe015b" href="signup.php"><span></span>Try Software Now
          </a>
                <a type="button"
        ...
        <div class="col-lg-7 text-center text-lg-end">
          <img loading="lazy" decoding="async" src="images/bg/features/chits-collection.png" alt="chit-collection" class="img-fluid rounded ">
        </div>   
      </div>
    </div>
    </section>
      ...
      <div class="container mt-4">
        <div class="row mt-2 align-items-center justify-content-between">
          <div class="section-title text-center">
            ...
            <h1>Features of Chits Collection <br> Software(Gold, Land and Finance)</h1>
    ...
    <div class="row justify-content-center align-items-center">
      ...
      <div class="col-lg-5">
        <div class="section-title">
          ...
          <a type="button"
          class="btn fs-6" style="background-color: #fe015b" href="signup.php" data-bs-toggle="modal" data-bs-target=""><span></span>Try Software Now
          </a>
          <a type="button"
      class="btn fs-6" style="background-color: #fe015b" href="#" data-bs-toggle="modal" data-bs-target="#talkExpert"><span></span>Talk to an
      Expert</a>
    ...
    <div class="row justify-content-center align-items-center">
      ...
      <div class="col-lg-5">
        <div class="section-title">
          ...
          <a type="button"
          class="btn fs-6" style="background-color: #fe015b" href="signup.php" data-bs-toggle="" data-bs-target=""><span></span>Try Software Now
          </a>
          <a type="button"
      class="btn fs-6" style="background-color: #fe015b" href="#" data-bs-toggle="modal" data-bs-target="#talkExpert"><span></span>Talk to an
      Expert</a>
