        ...
        <div class="pt-4 py-4 ">
            <section class="">
                <div class="">
                  ...
                  <h4 class="text-capitalize text-black" >United States</h4>
                  <p class="text-black">478 Westgate Dr. Edison, NJ 08820
                  </p>
                  <ul class="list-unstyled footer-menu mb-4 lh-35">
                    <h6><a href="tel: +65 9895 1817"  class="text-black" > <i class="bi bi-telephone-fill" style="color:#F4104E"></i>  +1 (617) 800-4606</a></h6>
                  ...
                  <ul class="list-unstyled footer-menu mb-4 lh-35">
                    ...
                    <h6><a href="mailto:info@zeppay.com"  class="text-black"> <i class="bi bi-envelope-fill" style="color:#F4104E"></i> info@zeppay.com</a></h6>
                        ...
                        <div class="col-md-4 p-4" style="background-color: #F0F0F0;">
                            <div class="form">
                                ...
                                <form name="frmcreatetrial" id="frmcreatetrial" class="init-sign-up mb-3" role="form" method="POST" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input name="mobile" id="mobile" class="form-control" type="text" pattern="[0-9.]{8,}" required placeholder="Phone Number" autocomplete="off" value="">
