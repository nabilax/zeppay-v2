    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form name="frmcreatetrial" id="frmcreatetrial" class="init-sign-up mb-3" role="form" method="POST" autocomplete="off">
                            ...
                            <button class="btn  mt-4 mb-4 fw-bold" style="background-color: #fe015b" type="submit" data-loading-text='<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> &nbsp; Please wait a moment...'>
                                Get Started
                            </button>
                        </form>
