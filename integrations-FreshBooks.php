      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="section-title">
            <h1 class="text-capitalize mb-4">Chase Your Invoices Directly From FreshBooks</h1>
        ...
        <div class="col-lg-7 text-center text-lg-end">
          ...
          <img loading="lazy" decoding="async" src="images/bg/features/fresh.png" width="20%" height="auto" class="img-fluid logoanim logoanimq">
        </div>   
      </div>
    </div>
    </section>
      ...
      <div class="container mt-4">
        <div class="row mt-2 align-items-center justify-content-between">
          <div class="section-title text-center">
            ...
            <h1>Features of Zeppay's FreshBooks <br> Plugin for FreshBooks Users</h1>
