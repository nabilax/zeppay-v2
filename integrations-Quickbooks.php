      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="section-title">
            <h1 class="text-capitalize mb-4">Chase Your Invoices Directly From Quick Books</h1>
            <p>Collect your Invoices 3 times faster by sending reminders with payment links!</p>
                <a type="button"
        ...
        <div class="col-lg-7 text-center text-lg-end">
          <img loading="lazy" decoding="async" src="images/bg/features/chits.png" alt="About Ourselves" class="img-fluid rounded ">
          <img loading="lazy" decoding="async" src="images/bg/features/qbook.png" width="20%" height="auto" alt="About Ourselves" class="img-fluid logoanim logoanimq">
        </div>   
      </div>
    </div>
    </section>
      ...
      <div class="container mt-4">
        <div class="row mt-2 align-items-center justify-content-between">
          <div class="section-title text-center">
            ...
            <h1>Features of Zeppay's QuickBooks <br> Plugin for QuickBooks Users</h1>
...
<section class="about-section bg-tertiary position-relative overflow-hidden">
  <div class="container mt-4 mb-4">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-6 text-center text-lg-end">
        <div class="row justify-content-center align-items-center">
