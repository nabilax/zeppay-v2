      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="section-title">
            <h1 class="text-capitalize mb-4">Fees Collection Software for Educational Institutions and Schools</h1>
            <p>Schools Fees Collection Software helps in finance management. Send and collect payments by sending links using WhatsApp, email, sms etc. Reminders for the due date, maturity and defaulted.</p>
                <a type="button"
        ...
        <div class="col-lg-7 text-center text-lg-end">
          <img loading="lazy" decoding="async" src="images/bg/features/school-fee-collection.png" alt="school-fee-collection" class="img-fluid rounded ">
        </div>   
      </div>
    </div>
    </section>
      ...
      <div class="container mt-4">
        <div class="row mt-2 align-items-center justify-content-between">
          <div class="section-title text-center">
            ...
            <h1>Features of Fees Collection Software <br> for Educational Institutions and Schools</h1>
